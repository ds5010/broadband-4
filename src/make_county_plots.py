...
plot_list = [
    ["tot_cov_pop", "Total Covered Populations in County", "pct_tot_cov_pop", "Percent Covered Populations in County", "covered_population"],
    ["ipr_pop", "Total Near Poverty Population", "pct_ipr_pop", "Percent Near Poverty Population Covered", "near_poverty"],
    ["aging_pop", "County population age 60 years and older", "pct_aging_pop", "Percent Ages 60+ Populations", "Age 60+"],
    ["incarc_pop", "County population incarcerated", "pct_incarc_pop", "Percent Incarcerated Populations", "Incarcerated"],
    ["dis_pop", "County population with disability", "pct_dis_pop", "Percent Disability Populations", "Disabled"],
    ["vet_pop", "County veteran population", "pct_vet_pop", "Percent Veterans Populations", "Veterans"],
    ["lang_barrier_pop", "County population with a language barrier", "pct_lang_barrier_pop", "Percent Language Barrier Populations", "Language Barrier"],
    ["no_bb_or_computer_pop", "County household population w/o Broadband or Computers", "pct_no_bb_or_computer_pop", "Percent Population w/o Broadband or Computers", "Lack Broadband or Computers"],
    ["minority_pop", "County population of minorities", "pct_minority_pop", "Percent Minority Populations", "Minorities"],
    ["rural_pop", "County population living in rural areas", "pct_rural_pop", "Percent Rural Populations", "People in Rural Areas"],
    ["lang_pop", "County population ESL 5 years and older", "pct_lang_pop", "Percent ESL 5 years and older", "Non-native English Speakers"],
    ["pct_low_literacy_pop_nces", "Percent Low Literacy", "pct_no_fixed_bb_pop_fcc", "Percent No Fixed Broadband", "County-level Only Columns"]
]
