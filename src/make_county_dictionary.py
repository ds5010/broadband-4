...
def save_county_dictionary():
    ...
    dictionary_df = pd.read_excel(excel, sheet_name='County File Layout', skiprows=4)
    ...
    # Save as json file
    with open('docs/dictionary_county.json', 'w') as file:
        json.dump(dict, file, indent=4)

save_county_dictionary()